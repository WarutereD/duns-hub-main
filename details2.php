		...
		?>
				<div>
					<center>
						...
						<h3 class="text-uppercase">Weight: <?php echo $row['product_weight']?></h3>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<select name="weight" required style="width:150px;">
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Wamagas Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
