		...
		<div id="content">
			<legend>Frequently Asked Questions</legend>			
					...
					<h4>DO YOU DELIVER?</h4>
						<p style="text-indent:60px;">Yes, Right at your doorstep.</p>
				<hr>
					<h4>WHEN WILL I GET MY ORDERS?</h4>
						<p style="text-indent:60px;">As soon as orders are place.</p>
				<hr>
					<h4>HOW DO I PAY MY ORDERS?</h4>
					<p style="text-indent:60px;">Through mpesa till or cash on delivery.</p>
